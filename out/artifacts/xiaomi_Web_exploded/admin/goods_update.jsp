...
<body>
    ...
    <div class="formbody">
	    ...
	    <form action="<%=basePath%>goods" method="post" enctype="multipart/form-data">
			...
			<input type="hidden" name="method" value="updateGoodsById">
		    <ul class="forminfo">
		    	<!-- 商品分类信息 -->
		    	<li>
		    		<label>商品分类</label>
			    ...
			    <li><label>商品名称</label><input name="gname" type="text" class="dfinput" value="${goods.gname}"/><i>商品名称不能超过30个字符</i></li>
			    <li><label>颜色</label><input name="color" type="text" class="dfinput" value="${goods.color}" /></li>
			    <li><label>规格尺寸</label><input name="size" type="text" class="dfinput" value="${goods.size}"/></li>
			    <li><label>单价</label><input name="price" type="text" class="dfinput" value="${goods.price}"/></li>
			    <li><label>简介</label>
			    ...
			    <li><label>商品展示图</label>
					...
					<img src="<%=imgPath%>${goods.pic}" width="80px">
			    ...
			    <li><label>型号</label><input name="version" type="text" class="dfinput" value="${goods.version}"/></li>
			    <li><label>生产日期</label>
			    	<input class="Wdate" style="width: 345px;height: 32px;line-height: 32px;" onclick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd HH:mm:ss'})" name="product_date" type="text" class="dfinput"
						   value="<fmt:formatDate value="${goods.product_date}" pattern="yyyy-MM-dd HH:mm:ss"></fmt:formatDate>" />
			    </li>
