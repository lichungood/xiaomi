...
<div id="main">
    <form name=alipayment action='alipay.trade.wap.pay' method=post target="_blank">
        <div id="body" style="clear:left">
            <dl class="content">
                <dt>商户订单号：</dt>
                <dd>
                    <input id="WIDout_trade_no" name="WIDout_trade_no" value="${orders.orders_number}"/>
                </dd>
                <hr class="one_line">
                <dt>订单名称：</dt>
                <dd>
                    <input id="WIDsubject" name="WIDsubject" value="${orders.ordersName}"/>
                </dd>
                <hr class="one_line">
                <dt>付款金额：</dt>
                <dd>
                    <input id="WIDtotal_amount" name="WIDtotal_amount" value="${orders.sumPrice}"/>
                </dd>
                <hr class="one_line"/>
                <dt>商品描述：</dt>
                <dd>
                    <input id="WIDbody" name="WIDbody" value="穷啊"/>
                </dd>
                <hr class="one_line">
                <dt></dt>
                <dd id="btn-dd">
