    ...
    else
    {
       // alert("====")
        $.ajax({
            ...
            type:"post",
            dataType:"json",
            data:{"method":"addTrolley","gid":gid},
            success:function (res)
            {if(!res)
            {
                //res：true,说明更新商品的个数，购物车不增加1；res：false,说明商品是第一次进入购物车，因此要做加1的计算
                var num = $("#trolleyNumber").text();
                $("#trolleyNumber").text(Number(num)+1);//Number(num)将字符串转为数字格式
            }
        ...
        <div class="plus5_no3_right">
            ...
            <div class="plus5_no3_right_div4">
                <div class="plus5_no3_right_div4_in">
                    <p class="plus5_no3_right_p4">赠品</p><span>赠送个屁</span>
                </div>
                <div class="plus5_no3_right_div4_in">
                    <p class="plus5_no3_right_p4">赠品</p><span>想得美</span>
                </div>


            </div>
            <div class="plus5_no3_right_div5">
                    <p >北京 北京市  <span class="plus5_no3_right_div5_span"><a class="plus5_no3_right_div5_span" href="">修改</a> &nbsp;&nbsp;  有现货</span></p>
            </div>
            ...
            <div class="plus5_no3_right_div10">
                <p class="plus5_no3_right_div10_p1">${goods.gname} <span class="plus5_no3_right_div10_span0">${goods.version}</span>
                    <span class="plus5_no3_right_div10_span1"></span>
                    <span class="plus5_no3_right_div10_span2">${goods.color }</span></p>
                <span class="plus5_no3_right_span10">${goods.price }元</span>
