   ...
   <%-- ${goodsTJ}--%>
        ...
        <div class="scroll_left" style="height: 420px;">
            <ul class="scr-ul">
                <c:forEach items="${categories}" var="cate">
                    <li class="scr_li"><a href="">${cate.cname}</a><i class="scr_i"></i></li>
                </c:forEach>
    ...
    <div class="bot">
        <div class="bot_max">
            ...
            <a href="#"><img src="img/3_02.jpg" alt="" width="316" height="170"></a>
            <a href="#"><img src="img/3_03.jpg" alt="" width="316" height="170"></a>
            <a href="#"><img src="img/3_04.jpg" alt="" width="316" height="170"></a>
        </div>
    </div>
    <div class="time">
        ...
        <div class="time_in">
        	    <!-- 动态数据时使用，已经修改过css -->
            <c:forEach items="${goodsStar}" var="goods">
            <div style="background-color: #fff;width: 234px;height:320px;float: left;margin-left: 11px; ">
                <a href="<%=basePath%>index?method=findGoodsDetailById&gid=${goods.gid }" target="_blank">
                    <img class="time_min" style="width:234px;height: 234px;" src="<%=imgPath%>${goods.pic}" alt="">
                </a>
                ...
                <div class="appr">
                    <div class="appr_top">
                    	<!-- 循环后台取到的家电的集合 -->
                    		...
                    		<!-- 动态获取数据时使用，已经修改过css -->
                   			<!-- 动态获取数据时使用，已经修改过css -->
                   		  <c:forEach items="${goodsJD}" var="goods" varStatus="i">
                              <c:if test="${i.index<4}">
                  			<%--第一排4个商品 --%>
                  			<div class="appr_min" id="appr_min1" style="margin-left: 12px;width: 234px;height: 300px;background-color: #FFF;text-align: center;">
                  			<a href="<%=basePath%>index?method=findGoodsDetailById&gid=${goods.gid }" target="_blank"><img width="180px" height="180px;" src="<%=imgPath%>${goods.pic}" alt=""></a>
                  			
                  			<div style="width: 234px;height: 100px;">
                  				<div style="width: 100%;height: 33px;text-align: center;font-size: 14px;font-family: Arial">${goods.gname}</div>
                  			...
                  			<a href="<%=basePath%>index?method=findGoodsDetailById&gid=${goods.gid }"><img width="180px" height="180px;" src="<%=imgPath%>${goods.pic}" alt=""></a>
                  			<div style="width: 234px;height: 100px;">
                  				<div style="width: 100%;height: 33px;text-align: center;font-size: 14px;font-family: Arial">${goods.gname}</div>
                  				<div style="width: 100%;height: 33px;text-align: center;font-size: 14px;font-family: Arial">
                                    <c:if test="${goods.description.length() <=12 }">
        ...
        <div class="capacity">
            <div class="capa_box_top">
            	...
            	<div class="capa_box scrip_capa_box scrip_capa_box_on">
                	<div class="capa_top">
                    	<!-- 智能家居 - 动态使用  -->
                        <c:forEach items="${goodsZN}" var="goods">
                   		<div class="capa capa_shadow" style="width: 231px;height: 301px;text-align: center;background-color: #FFFFFF;margin-top: 15px;">
	                        <a href="<%=basePath%>index?method=findGoodsDetailById&gid=${goods.gid }" target="_blank"><img width="180px" height="180px" src="<%=imgPath%>${goods.pic}">
	                            <div class="tran">
        ...
        <div class="capacity">
            ...
            <div class="capa_box">
                <div class="capa_top">
					...
					<!-- 动态数据使用，仅供参考 -->
					<c:forEach items="${goodsTJ}" var="goods">
	                	<div class="capa capa_shadow" style="margin-right: 10px;background-color: #fff">
	                        <a href="<%=basePath%>index?method=findGoodsDetailById&gid=${goods.gid }"><img width="234"  src="<%=imgPath %>${goods.pic}"></a>
	                        <div class="capa_a">
	                            <ul>
	                                <li style="color: #333333"> ${goods.gname } </li>
            	 ...
            	 <c:forEach items="${hotGoods }" var="goods" varStatus="i">
            		...
            		<c:if test="${i.count ==1 }">
            			<div class="popu popu_unleft popu_shadow" >
	                        <a href="<%=basePath%>index?method=findGoodsDetailById&gid=${goods.gid }" target="_blank"><img style="width: 296px" height="220px" src="<%=imgPath%>${goods.pic}"></a>
